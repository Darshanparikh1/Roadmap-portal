...
export function DevMailboxPage() {
  ...
  const mail = useQuery({
    ...
    queryFn: ({ signal }) => api<OutboxEmail[]>("/dev/mailbox", { query: { email, limit: 30 }, signal }),
      ...
      <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            Email delivery is simulated. Verification and password-reset messages land here instead of a real inbox.
          </p>
        </div>
